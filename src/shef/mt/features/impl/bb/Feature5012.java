...
public class Feature5012 extends Feature {

    //final static Float probThresh = 0.10f;

    public Feature5012() {
        setIndex(5012);
        setDescription("List of all minimum distribution of posterior probability (for each word) in the target sentence");
