...
//    						fw.write(text+" "+prob+"\r\n");
            ...
            shef.mt.tools.OpenFstWrapper.run(openfst, fstPath, isymsPath, osymsPath, fstPath + ".print", 100, false);
            shef.mt.xmlwrap.fst.FST fst = new shef.mt.xmlwrap.fst.FST(fstPath + ".print", outputFolder + File.separator + new File(fstPath).getName() + ".lst");
            fst.dfs();
        }
    }
